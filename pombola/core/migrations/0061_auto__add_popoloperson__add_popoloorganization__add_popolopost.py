...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PopoloPost'
        db.create_table(u'core_popolopost', (
            (u'post_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popolo.Post'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'core', ['PopoloPost'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PopoloPost'
        db.delete_table(u'core_popolopost')
    ...
    models = {
        ...
        u'core.popolopost': {
            'Meta': {'object_name': 'PopoloPost', '_ormbases': [u'popolo.Post']},
            ...
            u'post_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['popolo.Post']", 'unique': 'True', 'primary_key': 'True'}),
