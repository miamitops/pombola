...
class Migration(SchemaMigration):
    ...
    def _migrate_organisation_forwards(self, orm):
        org_content_type = orm['contenttypes.ContentType'].objects.get(app_label="popolo", model="organization")
        contact_content_type = orm['contenttypes.ContentType'].objects.get(app_label="popolo", model="contactdetail")
    ...
    def backwards(self, orm):
        ...
        orm.PopoloPost.objects.all().delete()
